...
public class Solution {
    ...
    public static String convertToDecimalSystem(String s) {
        ...
        if(s.startsWith("0x"))
            decimalNum = Integer.parseInt(s.substring(2), 16);
            else  if(s.startsWith("0b"))
                decimalNum = Integer.parseInt(s.substring(2), 2);
                else if(s.startsWith("0"))
                    decimalNum = Integer.parseInt(s.substring(1), 8);
                    else decimalNum = Integer.parseInt(s, 10);
